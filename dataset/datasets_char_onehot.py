...
from dataset.dataset_lmdb_char_onehot import ImageLmdb
...
class DataAugmentationForMAE(object):
    def __init__(self, args):
        ...
        self.image_masked_position_generator = RandomMaskingGenerator(args.window_size, args.mask_ratio, num_view=args.num_view,) # aug에는 마스킹이 필요없는데
