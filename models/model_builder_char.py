...
from .encoder import *
from .decoder import *
from .attn_decoder_char import AttentionRecognitionHead
from .embedding_head_char import Embedding
    ...
    for idx, enc_x_sample in enumerate(spl_enc_x):  # batch 만큼
      ...
      for i in range(26): # 0 ~ 25
        if i < N: # 0 ~ N-1 
          ...
          zero_embed = torch.zeros(300).unsqueeze(0).to('cuda')
