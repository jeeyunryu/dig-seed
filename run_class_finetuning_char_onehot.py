...
from dataset.datasets_char_onehot import build_dataset
from engine_for_finetuning_char_onehot import train_one_epoch, evaluate
from utils.utils import NativeScalerWithGradNormCount as NativeScaler
import utils.utils as utils
from scipy import interpolate
import modeling_pretrain_vit
from loss import *
from models.model_builder_char_onehot import RecModel, CTCRecModel, AttnRecModel
...
def main(args, ds_init):
    ...
    if args.eval:
        ...
        # np.save('./npy_files/embeddings_char_embed_feat.npy', embeddings)
        # np.save('./npy_files/labels_char_embed_feat.npy', labels)
        # print("임베딩과 라벨 저장 완료!")
        # test other datasets
